...
beautiful.init("/home/rbriggs/.config/awesome/theme.lua")
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ altkey            }, "b",     function () exec("banshee --next") end),
    awful.key({ altkey            }, "z",     function () exec("banshee --previous") end),
    awful.key({ altkey            }, "c",     function () exec("banshee --toggle-playing") end),
    awful.key({ altkey            }, "l",     function () exec("gnome-screensaver-command --lock") end),
    awful.key({ altkey            }, "space", function () exec("xlock") end)
)
...
awful.util.spawn_with_shell("nautilus -n --no-desktop")
awful.util.spawn_with_shell("gnome-sound-applet")
awful.util.spawn_with_shell("pidgin")
awful.util.spawn_with_shell("/opt/hipchat/HipChat/bin/HipChat")

client_start_up = true
